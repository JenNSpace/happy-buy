...
- [**Estado al 2026-08-21**](project/pendientes.md) — **leer primero**: saldos con las bodegas, cómo funciona la cuenta corriente (4 reglas que costaron encontrar), y qué quedó pendiente

- [Fase 2 — Compras + Inventario](project/fase2-compras-inventario.md) — construida, probada y **desplegada a producción el 2026-08-18**
- [Fase 3 — Finanzas](project/fase3-finanzas.md) — **construida y desplegada el 2026-08-19**. Destapó que las retenciones reales son 1,914%, no 1,5%
...
- [**No especular cuando se paga plata**](feedback/no-especular-con-la-plata.md) — la atribución histórica de envíos era una deducción, no un registro; y el patrón de repetir notas heredadas sin verificarlas (pasó 4 veces en una sesión)
...
- [ML: el límite de llamadas](reference/ml-limite-de-llamadas.md) — el 429 `local_rate_limited`, y por qué en Next 16 `force-cache` es obligatorio para cachear peticiones con `Authorization`
